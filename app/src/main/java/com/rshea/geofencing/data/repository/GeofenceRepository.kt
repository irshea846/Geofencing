...
import com.rshea.geofencing.data.datasources.GeofenceDao
import com.rshea.geofencing.data.datasources.GeofenceEntity
...
class GeofenceRepository @Inject constructor(private val geofenceDao: GeofenceDao) {
    ...
    val readGeofences: Flow<MutableList<GeofenceEntity>> = geofenceDao.readGeofence()
